...
def config2parser(model='CTC', data='train'):
	...
	parser.add_argument('--curriculum_limits', type=int, default=5)
	...
	if model == 'CTC':
		...
		parser.add_argument('--num_units_per_lstm', type=int, default=512)
		parser.add_argument('--num_units_fc', type=int, default=1024)
	# Training
	...
	parser.add_argument('--clip_gradients', type=float, default=100.)
